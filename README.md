...
${\text{\color{#606060}  i  \color{#61657B} dont  \color{#66668C} have  \color{#6060B1} an  \color{#5876B3} explicit  \color{#6B95BF} dni  \color{#68BCCD}  because  \color{#8ED2D9} they  \color{#A7C4CE} wouldnt  \color{#B4C9D4} care  \color{#B4C9D4} but \color{#C4D0D9} pro/darkships / profics / zoos / radquuers  \color{#D1D8E1} dni }}$
...
${\text{\color{#606060} im  \color{#61657B} a  \color{#66668C} really  \color{#6060B1} heavy  \color{#5876B3} isagi  \color{#6B95BF} and  \color{#68BCCD} noob  \color{#8ED2D9} fictionkin 😁 }}$
